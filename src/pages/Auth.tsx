    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md border-border bg-card">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold text-foreground">AI Learning Copilot</CardTitle>
          <CardDescription className="text-muted-foreground">Your personal AI tutor & coding assistant</CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <TabsContent value="signup">
              <form onSubmit={handleSignUp} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="signup-name" name="displayName" placeholder="Your name" required />
                </div>
                <div className="space-y-2">
